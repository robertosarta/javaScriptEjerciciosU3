...
function appendCard(userImage, userName, userAge, userEmail, userAddress, userEyeColor) {
  cardContainer.appendChild(userImage);
  cardContainer.appendChild(userName);
  cardContainer.appendChild(userAge);
  cardContainer.appendChild(userEmail);
  cardContainer.appendChild(userAddress);
  cardContainer.appendChild(userEyeColor);
  }
function buscar() {
